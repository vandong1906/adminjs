...
const start = async () => {
    ...
    app.get('/api/attributes', async (req, res) => {
        try {
            const attributeType = req.query.attribute_type;
    ...
    app.get('/admin/api/product-attributes', async (req, res) => {
        const productTypeId = req.query.product_type_id;
    ...
    app.get('/admin/api/customers', async (req, res) => {
        const params = {
            ...
            group_id: req.query.group_id ? parseInt(req.query.group_id) : undefined,
            fromDate: req.query.fromDate,
            toDate: req.query.toDate,
            sort: req.query.sort,
            order: req.query.order,
    ...
    app.post('/admin/api/discounts/validate', async (req, res) => {
        ...
        const result = await DiscountHandler.validateDiscount(code, customer_id ? parseInt(customer_id) : undefined, cart_total ? parseFloat(cart_total) : undefined);
        if (result.success) {
            res.json(result.discount);
        }
        else {
